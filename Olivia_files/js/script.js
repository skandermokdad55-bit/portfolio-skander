...
// Image Popup Gallery with Magnific Popup
$(document).ready(function() {
...
$(document).ready(function() {
    ...
    const cvSelectorBtn = $('#cv-selector-btn');
    const cvModalClose = $('.cv-modal-close');
    const cvOptions = $('.cv-option');

    // Open modal
    cvSelectorBtn.on('click', function() {
        cvModal.addClass('active');
    });

    // Close modal
    cvModalClose.on('click', function() {
        cvModal.removeClass('active');
    });

    // Close modal when clicking outside
    $(window).on('click', function(event) {
        if (event.target.id === 'cv-modal') {
            cvModal.removeClass('active');
        }
    });

    // Handle CV selection
    cvOptions.on('click', function() {
        const cvPath = $(this).data('cv');
...
// // Disable Ctrl+I (Inspect for Firefox)
// document.addEventListener('keydown', function(e) {
...
// // Disable Ctrl+J (Console for Firefox)
// document.addEventListener('keydown', function(e) {
